...
class Admin extends Component {
  ...
  renderPage = () => {
          ...
          <div className="wineCol">
            <div className="wineTitleWrap">
              <div className="wineTitleWrap1">
                ...
                <div><button onClick={()=>this.showMasterWineList()}className="addwinebtnmain"><i className="fas fa-wine-bottle"></i>
                  </button>
            </div>
              </div>
            </div>
          ...
          <div className="employeeCol">
            <div className="empTitleWrap">
              <div className="empTitleWrap1">
                ...
                <div><button className="addempbtnmain" onClick={() => this.hideShowEmpForm()}><i className="fas fa-user-plus"></i></button></div>
              </div>
            </div>
    ...
    } else if (this.state.currentPage === "WinesPage") {
      return <>
               WinesPage
                 </>;
    } else if (this.state.currentPage === "EmployeePage") {
      return <>
            EmployeesPage
                </>;
